...
Começando na versão 1810, esta versão do sistema operacional é compatível com as seguintes funções:
...
Esta versão do sistema operacional é compatível com as seguintes funções:
...
> [!Warning]  
> O Windows Server 2008 não oferece suporte a TLS 1.2. Se você habilitar esse protocolo em seu ambiente, os computadores com Windows Server 2008 não se comunicarão mais com o site. Para obter mais informações, confira [Como habilitar o TLS 1.2 para o Configuration Manager](/sccm/core/plan-design/security/enable-tls-1-2).  


## <a name="bkmk_client"></a> Versões do SO do cliente

As seguintes versões de sistema operacional do cliente têm suporte para uso como um **ponto de distribuição** <sup>[Observação 1](#bkmk_note1)</sup>:  
...
## <a name="bkmk_core"></a> Instalações de núcleo de servidor
