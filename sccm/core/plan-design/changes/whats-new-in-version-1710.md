...
### <a name="improved-vpn-profile-experience-in-configuration-manager-console----1318232---"></a>Melhoria da experiência do perfil de VPN no Console do Configuration Manager <!-- 1318232 -->
...
Quando estiver pronto para instalar esta versão, consulte [Atualizações para o System Center Configuration Manager](/sccm/core/servers/manage/updates).
