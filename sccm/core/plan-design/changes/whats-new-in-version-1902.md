...
Para obter mais informações, consulte [Como monitorar clientes](/sccm/core/clients/manage/monitor-clients#bkmk_health).
...
<!--3556027, fka 1359388-->
Esta versão inclui várias melhorias para ajudá-lo a criar e gerenciar de maneira melhor a mídia de sequência de tarefas. Para saber mais, confira os seguintes artigos sobre tipos de mídia específicos:
...
<!-- 3612513 -->
Existem novos componentes exigidos ao instalar o console do Configuration Manager. Se você criar um pacote para a instalação do console em outros computadores, verifique se que o pacote inclui os seguintes arquivos:
