...
|-----------|---|--------------|  
|Aplicativos disponíveis para o usuário, que anteriormente apareciam apenas no catálogo de aplicativos, agora aparecem no novo Centro de Software. </br></br>Portanto, a experiência de catálogo de aplicativos da web não estará disponível nos próximos meses.|11 de agosto de 2017| O suporte para a experiência de usuário do site do catálogo de aplicativos termina com a primeira atualização liberada após 1º de junho de 2018|
