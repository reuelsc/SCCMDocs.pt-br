...
> [!TIP]
> A versão 1702 ainda está disponível como [mídia de linha de base](/sccm/core/servers/manage/updates#bkmk_Baselines) que você pode usar para instalar o primeiro site de uma nova hierarquia.
