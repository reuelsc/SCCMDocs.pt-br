 ...
 **Verifique se todos os sites executam uma versão com suporte do System Center Configuration Manager:** todos os servidores do site na hierarquia devem executar a versão 1511 do System Center Configuration Manager para que você possa iniciar a instalação da atualização 1602.  

 **Examine as versões do .NET instaladas nos servidores do sistema de sites:** quando um site instala a atualização 1602, o Configuration Manager instala automaticamente o .NET Framework 4.5.2 em cada computador que hospeda uma das seguintes funções do sistema de sites quando o .NET Framework 4.5 ou posterior ainda não está instalado:  
