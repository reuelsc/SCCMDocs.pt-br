...
> [!TIP]  
> O ponto de serviço do Data Warehouse, introduzido com a versão 1702, é um recurso de pré-lançamento. Para habilitá-lo, confira [Usar recursos de pré-lançamento](/sccm/core/servers/manage/pre-release-features).
...
**Configurar a falha**  
 A instalação do ponto de serviço do Data Warehouse falhará em um servidor de sistema de site remoto quando o data warehouse for a primeira função de sistema de site instalada nesse computador.  
  - **Solução**:   
...
A sincronização falha com o seguinte no *Microsoft.ConfigMgrDataWarehouse.log*: **"Falha ao preencher objetos de esquema"**  
 - **Solução**:  
