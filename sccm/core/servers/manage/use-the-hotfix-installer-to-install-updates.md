...
##  <a name="bkmk_Overview"></a> Visão geral dos hotfixes do Configuration Manager  
...
####  <a name="bkmk_database"></a> Atualizar um banco de dados do site  
...
###  <a name="BKMK_console"></a> Atualizar consoles do Configuration Manager  
...
##  <a name="BKMK_Deploy"></a> Implantar atualizações para o Configuration Manager  
...
###  <a name="BKMK_DeploySWDist"></a> Usar a implantação de software para instalar atualizações  
...
###  <a name="BKMK_DeployCollections"></a> Criar coleções para implantar atualizações no Configuration Manager  
