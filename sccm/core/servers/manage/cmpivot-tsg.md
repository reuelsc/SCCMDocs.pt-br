...
> [!NOTE]
> A entrada de log acima no Statesys.log fica visível apenas quando o Log detalhado está habilitado para o componente SMS_STATE_SYSTEM, e isso pode ser feito modificando-se esta chave do registro: HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\SMS\COMPONENTS\SMS_STATE_SYSTEM\Verbose logging = 1 (padrão é 0)
