---
title: Encontrar ajuda | Microsoft Docs
...
##  <a name="a-namebkmkinfoa-information-and-support"></a><a name="bkmk_Info"></a> Informações e suporte  
 Use os recursos a seguir para ver informações adicionais sobre o Configuration Manager.  

-   **Para acessar a documentação mais recente do produto System Center Configuration Manager:** use a [Biblioteca de Documentação para o System Center Configuration Manager](http://go.microsoft.com/fwlink/p/?LinkId=691974) do TechNet  
...
###  <a name="a-namebkmksearchtipsa-search-the-documentation-library"></a><a name="BKMK_SearchTips"></a> Pesquisar na biblioteca de documentação  
 Use as seguintes dicas de pesquisa para ajudá-lo a encontrar as informações de que você precisa:  

-   Ao usar seu mecanismo de busca preferido para localizar conteúdo para o System Center Configuration Manager, você pode ajudar a definir o escopo dos resultados da pesquisa a apenas os da biblioteca de conteúdo atual, incluindo os dois termos a seguir entre aspas: **“branch atual”** e **“System Center Configuration Manager”**  

-   Use termos de pesquisa que correspondam àqueles que você vê na interface do usuário e na documentação online no lugar de termos não oficiais ou abreviações que podem ser vistos no conteúdo da comunidade. Por exemplo, procure por "ponto de gerenciamento" e não "PG", "tipo de implantação" e não "TI" e "atualizações de software" e não "SUM".  

-   Quando você faz pesquisa em uma página no TechNet ou no arquivo de ajuda (por exemplo, pressione Ctrl-F1 e insira os termos de pesquisa na caixa **Localizar** ), os resultados excluem o texto das seções recolhidas. Para pesquisar texto em seções recolhidas, expanda as seções antes de pesquisar na página. Para fazer isso, você pode clicar no botão **Expandir Tudo** na parte superior da página ou clicar duas vezes em qualquer seção recolhida. Quando todas as seções estiverem expandidas, uma pesquisa na página incluirá todas as seções contidas nessa página.  
...
-   Sempre que possível, use a biblioteca online do TechNet em vez da documentação baixada. O TechNet contém as informações mais atualizadas e você está pesquisando as que podem não estar na documentação baixada ou poderá haver correções ou informações online adicionais.  

-   Se você achar mais rápido e fácil pesquisar a documentação quando ela estiver armazenada localmente, selecione vários tópicos no TechNet e salve-os localmente. **Entre no TechNet**e, na parte superior da página que você deseja salvar localmente, clique em **Exportar** (ao lado de **Imprimir**). Você verá a faixa **Exportar vários conjuntos de páginas** que permite adicionar e remover as páginas que você deseja salvar. Em seguida, clique em **Gerenciar páginas** para exportá-las. Para obter mais informações, clique em **Ajuda** na faixa.  

###  <a name="a-namebkmkproductgroupbloga-the-system-center-configuration-manager-team-blog"></a><a name="BKMK_ProductGroupBlog"></a> Blog da equipe do System Center Configuration Manager  
...
###  <a name="a-namebkmksupportoptionsa-support-options-and-community-resources"></a><a name="BKMK_SupportOptions"></a> Opções de suporte e recursos da comunidade  
...
-   [Comunidade do Configuration Manager – Guia de sobrevivência do System Center Configuration Manager (branch atual)](http://social.technet.microsoft.com/wiki/contents/articles/33035.system-center-configuration-manager-current-branch-survival-guide.aspx )  
