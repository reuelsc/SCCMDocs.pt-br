...
- **Coleta de dados:**  
  ...
  -   **Conta do site de origem:** Esta conta é usada para acessar o Provedor de SMS do site de origem.  
  ...
  -   **Conta do Banco de Dados do Site de Origem:** essa conta é usada para acessar o banco de dados do SQL Server do site de origem e exige as permissões **Conectar**, **Executar**e **Selecionar** para o banco de dados do site de origem.  
