...
###  <a name="a-namebkmkmodifyexclusionlista-modify-the-exclusion-list-for-migration"></a><a name="BKMK_Modify_Exclusion_List"></a> Modificar a lista de exclusões para migração  
...
##  <a name="a-namecompletemigrationa-finish-migration"></a><a name="Complete_Migration"></a> Concluir a migração  
