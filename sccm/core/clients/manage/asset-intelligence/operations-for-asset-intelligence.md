...
- **Status do software inventariado**: fornece a contagem e o percentual de software inventariado, as categorias de software e as famílias de software identificadas pela Microsoft, identificadas por um usuário administrativo, com identificação online pendente ou não identificadas e não pendentes. As informações exibidas em formato de tabela mostram a contagem para cada um, enquanto as informações exibidas no gráfico mostram o percentual de cada um.  
...
2.  No workspace **Monitoramento**, expanda **Relatório**, expanda **Relatórios** e clique em **Asset Intelligence**. Os relatórios do Asset Intelligence são exibidos.  
...
2. No workspace **Ativos e Conformidade**, clique em **Asset Intelligence**.  
...
5. Clique em **OK** para salvar as alterações.  
   ...
   > [!NOTE]  
   >  Para obter informações sobre o agendamento de sincronização, incluindo a próxima sincronização agendada, veja o nó **Asset Intelligence** do workspace **Ativos e Conformidade** no site de nível superior da hierarquia.  
...
2.  No workspace **Ativos e Conformidade**, clique em **Asset Intelligence** e em **Catálogo**.  
...
2. No workspace **Ativos e Conformidade**, clique em **Asset Intelligence** e em **Requisitos de Hardware**.  

3. Na guia **Início** , no grupo **Criar** , clique em **Criar Requisitos de Hardware**.  

4. Na página **Geral** , insira as seguintes informações:  

   1. **Título do software**: especifica o título do software ao qual os requisitos de hardware estão associados. O título de software não pode existir no catálogo do Asset Intelligence.  
   ...
   3. **CPU mínima (MHz)**: especifica a velocidade mínima do processador, em MHz (mega-hertz) exigida pelo título do software.  

   4. **RAM mínima (KB)**: especifica a RAM mínima, em quilobytes (KB), exigida pelo título do software.  

   5. **Espaço mínimo em disco (KB)**: especifica o espaço livre mínimo em disco, em KB, exigido pelo título do software.  

   6. **Tamanho mínimo do disco (KB)**: especifica o tamanho mínimo do disco, em KB, exigido pelo título do software.  
...
2. No workspace **Ativos e Conformidade**, clique em **Asset Intelligence** e em **Software Inventariado**.  
...
5. Na guia **Geral** , é possível modificar as seguintes informações de categorização:  
   ...
   -   **Nome do produto**: especifica o nome do título do software inventariado.  

   -   **Fornecedor**: especifica o nome do fornecedor que desenvolveu o título do software inventariado.  

   -   **Categoria**: especifica a categoria de software que está atribuída no momento ao título do software inventariado.  

   -   **Família**: especifica a família de software que está atribuída no momento ao título do software inventariado.  
