---
title: "Propriedades de instalação do cliente | System Center Configuration Manager"
...
-   **SMSCONFIGSOURCE**  
    ...
    -   R: verificar as definições de configurações no Registro.  
         ...
         Clique aqui para obter [informações sobre como armazenar propriedades de instalação do cliente no Registro](https://technet.microsoft.com/library/gg712298.aspx#BKMK_Provision).  
