...
#### <a name="the-configuration-manager-trusted-root-key-certificate"></a>O certificado de chave de raiz confiável do Configuration Manager  
...
#### <a name="the-site-server-signing-certificate"></a>O certificado de autenticação de servidor do site  
...
Você pode saber mais sobre a coleta e o uso de dados da Microsoft na [Política de Privacidade da Microsoft](https://privacy.microsoft.com/privacystatement).
