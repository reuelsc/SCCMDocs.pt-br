...
Para saber mais sobre essa conta, confira [Conta de Conexão do Ponto de Atualização de Software](/sccm/core/plan-design/hierarchy/accounts#software-update-point-connection-account).<!--515492-->  
