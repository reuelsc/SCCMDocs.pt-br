...
description: Conheça os novos recursos disponíveis no branch do Configuration Manager Technical Preview versão 1812.
ms.date: 12/14/2018
...
ms.locfileid: "53444731"
---
# <a name="capabilities-in-configuration-manager-technical-preview-version-1812"></a>Funcionalidades no Configuration Manager Technical Preview versão 1812 

*Aplica-se a: System Center Configuration Manager (Technical Preview)*

Este artigo apresenta os recursos disponíveis no Configuration Manager Technical Preview, versão 1812. Instale esta versão para atualizar e adicionar novos recursos ao seu site da visualização técnica. 
