...
### <a name="technical-preview-version-1901"></a>Technical Preview versão 1901

<!-- - [title](/sccm/core/get-started/2019/technical-preview-1901#bkmk_anchor)<!--ID-->


- [Painel de integridade do cliente](/sccm/core/get-started/2019/technical-preview-1901#bkmk_health)<!--3599209-->  
- [Especificar a prioridade para as atualizações de recurso no serviço do Windows 10](/sccm/core/get-started/2019/technical-preview-1901#bkmk_neo)<!--3734525-->  
- [Monitoramento dedicado para implantações em fases](/sccm/core/get-started/2019/technical-preview-1901#bkmk_pod)<!--3555949--> 
- [Executar o CMPivot do site de administração central](/sccm/core/get-started/2019/technical-preview-1901#bkmk_cmpivot)<!--3610960-->  
- [Melhorias na etapa da sequência de tarefas Executar Script do PowerShell](/sccm/core/get-started/2019/technical-preview-1901#bkmk_posh)<!--3556028-->  
- [Produtos do Office no painel de ciclo de vida](/sccm/core/get-started/2019/technical-preview-1901#bkmk_lifecycle)<!--3556026-->  
- [Regras de insight de gerenciamento para coleções](/sccm/core/get-started/2019/technical-preview-1901#bkmk_micoll)<!--3555752-->  
- [Pesquisar nas exibições de dispositivo usando o endereço MAC](/sccm/core/get-started/2019/technical-preview-1901#bkmk_mac)<!--3600878-->  
- [Modo de manutenção de ponto de distribuição](/sccm/core/get-started/2019/technical-preview-1901#bkmk_dpmaint)<!--3555754-->  
- [Serviço de imagens otimizadas](/sccm/core/get-started/2019/technical-preview-1901#bkmk_resetbase)<!--3555951-->  
- [Importar um único índice de uma imagem do sistema operacional](/sccm/core/get-started/2019/technical-preview-1901#bkmk_index)<!--3719699--> 
- [Usar o Azure Resource Manager para serviços de nuvem](/sccm/core/get-started/2019/technical-preview-1901#bkmk_arm)<!--3605704-->  
- [Confirmação de comentários do console](/sccm/core/get-started/2019/technical-preview-1901#bkmk_feedback)<!--3556010--> 
- [Criar um laboratório do Configuration Manager Technical Preview no Azure](/sccm/core/get-started/2019/technical-preview-1901#bkmk_azurevm)<!--3556017-->  
- [Especificar uma porta personalizada para ativação de par](/sccm/core/get-started/2019/technical-preview-1901#bkmk_sleep)<!--3605925-->  
- [Exibir consoles conectados recentemente](/sccm/core/get-started/2019/technical-preview-1901#bkmk_console)<!--3699367-->  
- [Interromper o serviço de nuvem quando ele excede o limite](/sccm/core/get-started/2019/technical-preview-1901#bkmk_cmg)<!--3735092--> 
- [Tempo limite do modo de provisionamento de cliente](/sccm/core/get-started/2019/technical-preview-1901#bkmk_osdprov)<!--3197824-->
- [Melhorias na implantação do sistema operacional](/sccm/core/get-started/2019/technical-preview-1901#bkmk_osd)<!--3633146,3641475,3654172,3734270-->
