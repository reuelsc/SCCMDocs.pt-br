...
description: Conheça os novos recursos disponíveis na versão 1811 do branch da visualização técnica do Configuration Manager.
ms.date: 12/03/2018
...
ms.locfileid: "59802284"
---
# <a name="capabilities-in-configuration-manager-technical-preview-version-1811"></a>Funcionalidades na versão 1811 da visualização técnica do Configuration Manager 

*Aplica-se a: System Center Configuration Manager (Technical Preview)*

Este artigo apresenta os recursos disponíveis na visualização técnica do Configuration Manager, versão 1811. Instale esta versão para atualizar e adicionar novos recursos ao seu site da visualização técnica. 
