...
##  <a name="BKMK_SUPInfrastructure"></a> Determinar a infraestrutura do ponto de atualização de software  
 O site de administração central e todos os sites primários filho devem ter um ponto de atualização de software onde você implanta atualizações de software. Enquanto planeja a infraestrutura do ponto de atualização de software, você precisa determinar as seguintes dependências:
