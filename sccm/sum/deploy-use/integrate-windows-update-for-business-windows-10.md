...
>[!WARNING]
> Se você estiver usando o cogerenciamento para seus dispositivos e você moveu o [políticas de atualização do Windows](/sccm/comanage/workloads#windows-update-policies) para o Intune, em seguida, seus dispositivos terão seus [políticas de atualização do Windows para empresas do Intune](https://docs.microsoft.com/intune/windows-update-for-business-configure).
> - Se o cliente do Configuration Manager ainda estiver instalado no dispositivo gerenciado em conjunto, em seguida, as configurações para atualizações cumulativas e atualizações de recursos são gerenciadas pelo Intune. No entanto, patches de terceiros, se habilitada em [ **configurações do cliente**](/sccm/core/clients/deploy/about-client-settings#enable-third-party-software-updates), ainda é gerenciado pelo Configuration Manager.  
...
-   O Configuration Manager ainda poderá implantar as atualizações de terceiros publicadas no WSUS e gerenciadas por meio do Configuration Manager para clientes que estão conectados no WUfB para receber atualizações. Se você não quiser as atualizações de terceiros 3ª para ser instalado em clientes que se conectam ao WUfB, desabilite a configuração nomeada do cliente [habilitar atualizações de software em clientes](/sccm/core/clients/deploy/about-client-settings#software-updates).
...
>[!NOTE] 
>A partir do Configuration Manager versão 1802, você pode definir políticas de adiamento para o programa Windows Insider. <!--507201-->Para saber mais sobre o programa Windows Insider, confira [Introdução ao programa Windows Insider para Empresas](https://docs.microsoft.com/windows/deployment/update/waas-windows-insider-for-business).
...
4. Na página **Políticas de Adiamento**, defina se deseja adiar ou pausar as Atualizações de Recurso. Normalmente, as Atualizações de Recurso são recursos novos do Windows. Depois de definir a configuração **Nível de preparação do branch**, defina se, e por quanto tempo, você quer adiar o recebimento de Atualizações de Recurso após a disponibilização da Microsoft.
    ...
    - **Período de adiamento (dias)**: especifique o número de dias durante os quais as Atualizações de Recurso serão adiadas. Você pode adiar o recebimento dessas Atualizações de Recursos por um período de 365 dias a partir do lançamento.
    - **Pausar Atualizações de Recursos a partir de**: selecione se você quer pausar o recebimento de Atualizações de Recursos nos dispositivos durante um período de até 60 dias a partir do momento que você pausar as atualizações. Após o número máximo de dias, a funcionalidade de pausa expirará automaticamente, e o dispositivo verificará no Windows Update se há atualizações aplicáveis. Após essa verificação, você poderá pausar as atualizações novamente. Retome as Atualizações de Recurso desmarcando a caixa de seleção.   
