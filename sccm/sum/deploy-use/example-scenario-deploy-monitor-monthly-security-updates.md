...
##  <a name="a-namebkmkstep1a-step-1-create-a-software-update-group-for-yearly-compliance"></a><a name="BKMK_Step1"></a> Etapa 1: Criar um grupo de atualização de software para fins de conformidade anual  
...
##  <a name="a-namebkmkstep2a-step-2-create-an-automatic-deployment-rule-for-the-current-month"></a><a name="BKMK_Step2"></a> Etapa 2: Criar uma regra de implantação automática para o mês atual  
...
##  <a name="a-namebkmkstep3a-step-3-verify-that-software-updates-are-ready-to-deploy"></a><a name="BKMK_Step3"></a> Etapa 3: Verificar se as atualizações de software estão prontas para ser implantadas  
...
##  <a name="a-namebkmkstep4a-step-4-deploy-the-software-update-group"></a><a name="BKMK_Step4"></a> Etapa 4: Implantar o grupo de atualização de software  
