...
Para obter informações sobre como implantar perfis de email do Exchange ActiveSync, consulte [Como implantar perfis no System Center Configuration Manager](deploy-wifi-vpn-email-cert-profiles.md).  
