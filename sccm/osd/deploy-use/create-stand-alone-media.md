---
title: "Criar mídia autônoma com o System Center Configuration Manager"
...
7.  Na página **CD/DVD Autônomo** , especifique a sequência de tarefas que implanta o sistema operacional e clique em **Próxima**. O assistente permite que você selecione apenas as sequências de tarefas associadas a uma imagem de inicialização.  
...
##  <a name="a-namebkmkstandalonemediatsexamplea-example-task-sequence-for-stand-alone-media"></a><a name="BKMK_StandAloneMediaTSExample"></a> Exemplo de sequência de tarefas para mídia autônoma  
