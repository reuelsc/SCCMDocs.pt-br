---
title: "Segurança e privacidade para a implantação de sistema operacional | Configuration Manager"
...
##  <a name="a-namebkmksecurityhardwareinventorya-security-best-practices-for-operating-system-deployment"></a><a name="BKMK_Security_HardwareInventory"></a> Práticas recomendadas de segurança para a implantação de sistema operacional  
...
##  <a name="a-namebkmkprivacyhardwareinventorya-privacy-information-for-operating-system-deployment"></a><a name="BKMK_Privacy_HardwareInventory"></a> Informações de privacidade da implantação de sistema operacional  
