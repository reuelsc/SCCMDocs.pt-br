...
Para obter mais informações sobre como habilitar esse recurso, veja [Pré-lançamento de recursos](/sccm/core/servers/manage/pre-release-features).
