...
3. **User1**do dispositivos agora são gerenciados pelo Intune no portal do Azure.  

4. Todos os outros dispositivos continuam a ser gerenciados no console do Configuration Manager.  

> [!Important]  
> Quando você move um usuário de híbrida para autônomo, remoção de política está suspenso por sete dias.<!-- SCCMDocs issue #1066 -->
...
Especifique um parâmetro para desabilitar o prompt Deve Continuar.
