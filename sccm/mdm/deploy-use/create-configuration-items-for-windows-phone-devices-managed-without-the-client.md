...
---
# <a name="how-to-create-configuration-items-for-windows-phone-devices-managed-with-intune"></a>Como criar itens de configuração para dispositivos com Windows Phone gerenciados com o Intune
...
8.  Na página **Configurações do Dispositivo**, selecione o grupo de configurações que você deseja configurar. Consulte [Referência de configurações de itens de configuração do Windows Phone](#windows-phone-configuration-item-settings-reference) neste tópico para obter detalhes e clique em **Avançar**.  
