...
# [Classes de Provedor de Conteúdo Alternativo](core/servers/configure/alternate-content-provider-classes.md)
...
# [Classes WMI de Servidor de Status de Cliente](core/clients/status/client-status-server-wmi-classes.md)
...
# [Classes de WMI de Servidor de Gerenciamento de Dispositivo](mdm/device-management-server-wmi-classes.md)
...
# [Classes de Descoberta](core/servers/configure/discovery-classes.md)
...
### [CreateMedia.exe de Implantação de Sistema Operacional](osd/operating-system-deployment-createmedia.exe.md)

# [Classes WMI de Servidor de Gerenciamento Fora de Banda](misc/out-of-band-management-server-wmi-classes.md)
...
# [Classes WMI de Servidor de Relatórios](core/servers/reporting/configuration-manager-reporting-server-wmi-classes.md)
...
# [Classes WMI de Servidor de Gerenciamento de Recursos](core/clients/manage/configuration-manager-resource-management-server-wmi-classes.md)
## [Classes WMI de Servidor de inventário de hardware](core/clients/manage/hardware-inventory-server-wmi-classes.md)
...
# [Classes WMI de Servidor de administração baseada em função](core/servers/configure/role-based-administration-server-wmi-classes.md)
## [Classe WMI de Servidor de SMS_Admin](core/servers/configure/sms_admin-server-wmi-class.md)
...
# [Agendamento de Classes WMI de Servidor](core/servers/configure/scheduling-server-wmi-classes.md)
...
# [Classes WMI de Servidor de Configuração de Site](core/servers/configure/site-configuration-server-wmi-classes.md)
...
# [Classes WMI de Servidor de Distribuição de Software](core/servers/configure/software-distribution-server-wmi-classes.md)
...
# [Classes WMI de Servidor de Medição de Software](apps/software-metering-server-wmi-classes.md)
...
# [Classes WMI de Servidor de Atualizações de Software](sum/software-updates-server-wmi-classes.md)
...
# [Classes WMI de Servidor de Suporte](misc/supporting-server-wmi-classes.md)
...
# [Classes de Status](core/servers/manage/status-classes.md)
## [APIs de Cliente de Status](core/servers/manage/status-client-apis.md)
### [Funções de Mensagem de Status Smscstat.dll](core/servers/manage/smscstat.dll-status-message-functions.md)
...
## [Tipos de Mensagem de Status](core/servers/manage/status-message-types.md)
...
## [Funções de Status MIF](core/servers/manage/status-mif-functions.md)
...
## [API de Servidor de Status](core/servers/manage/status-server-api.md)
...
## [Classes WMI de Servidor de Status](core/servers/manage/status-server-wmi-classes.md)
...
### [Classe WMI de Servidor SMS_StatInsStr](core/servers/manage/sms_statinsstr-server-wmi-class.md)
### [Classe WMI de Servidor SMS_StatMsg](core/servers/manage/sms_statmsg-server-wmi-class.md)
...
# [Classes WMI do Windows Azure Server](core/servers/configure/windows-azure-server-wmi-classes.md)
...
# [Classes WMI de Servidor de Manutenção do Windows 10](misc/windows-10-servicing-server-wmi-classes.md)
...
# [Referência gerenciada do Configuration Manager](https://msdn.microsoft.com/library/mt767606.aspx)
