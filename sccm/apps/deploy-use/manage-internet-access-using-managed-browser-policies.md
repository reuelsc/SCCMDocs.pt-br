---
title: "Gerenciar o acesso à Internet usando políticas do Managed Browser | System Center Configuration Manager"
...
No System Center Configuration Manager, você pode implantar o Intune Managed Browser, um aplicativo de navegação na Web, e associá-lo a uma política do Managed Browser navegador gerenciado. A política de Managed Browser configura uma lista de permissões ou de bloqueio que restringe os sites que os usuários do Managed Browser podem visitar.  
  
 Como esse aplicativo é um aplicativo gerenciado, você também pode aplicar políticas de gerenciamento de aplicativo móvel ao aplicativo, como controlar o uso dos comandos recortar, copiar e colar, impedir capturas de tela e garantir que os links para conteúdos em que os usuários clicam abram somente em outros aplicativos gerenciados. Para ver os detalhes [Proteger aplicativos usando políticas de gerenciamento de aplicativos móveis](../../apps/deploy-use/protect-apps-using-mam-policies.md).  
...
5.  Na página **Tipo de Política** , selecione a plataforma, selecione **Managed Browser** para o tipo de política e clique em **Próximo**.  
    ...
    > [!NOTE]  
    >  O tipo de política **Geral** permite modificar a funcionalidade dos aplicativos implantados para ajudar a alinhá-los com as políticas de conformidade e segurança de sua empresa. Por exemplo, é possível restringir as operações de recortar, copiar e colar em um aplicativo restrito. Para obter mais informações sobre o tipo de política Geral, consulte [Proteger aplicativos usando políticas de gerenciamento de aplicativos móveis](../../apps/deploy-use/protect-apps-using-mam-policies.md).  
...
## <a name="create-a-software-deployment-for-the-managed-browser-app"></a>Crie uma implantação de software para o aplicativo de navegador gerenciado  
 ...
 Para mais informações, consulte [Criar aplicativos](../../apps/deploy-use/create-applications.md).  
